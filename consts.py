...
### START SCREEN CONSTANTS(coordinates in pixels) ###
XSTART = GAME_WIDTH / 2
YSTART = GAME_HEIGHT / 2
FONTSIZESTART = GAME_WIDTH / 25
TEXTSTART = "Press 's' to Play, press 'm' to toggle sound"

### SCORE LABEL ###
SCORE_WIDTH = GAME_WIDTH / 10
SCORE_HEIGHT = GAME_HEIGHT / 18

### SOUND CONSTANTS ###
LASER_SOUNDS = ['laser-1.wav', 'laser-2.wav', 'laser-3.wav']
ALIEN_DEATH_SOUNDS = ['bleh.wav', 'omf.wav']
### SHIP CONSTANTS ###
